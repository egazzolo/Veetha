export default {
  ...
  // Meal comparison
  compare: {
    title: 'Comparer les Repas',
    olderMeals: 'Repas plus anciens',
    needTwo: 'Sélectionnez au moins 2 repas à comparer',
    unnamedMeal: 'Repas',
    ...
    duplicatesHidden: 'Les repas enregistrés plusieurs fois n\'apparaissent qu\'une seule fois ici, avec la version la plus récente.',
  },

  // Progress photos & weight check-ins
  progress: {
    checkInTitle: 'Suivi de Progression',
    tipsLink: 'Conseils photo',
    captureFailed: 'Impossible de prendre la photo. Veuillez réessayer.',
    missingWeightTitle: 'Entrez votre poids',
    missingWeightBody: 'Veuillez entrer votre poids actuel pour enregistrer ce suivi.',
    saveFailed: 'Impossible d\'enregistrer votre suivi. Veuillez réessayer.',
    currentWeight: 'Poids actuel',
    retake: 'Reprendre la photo',
    lineUpHint: 'Alignez-vous avec le contour pour des photos cohérentes',
    saveCheckIn: 'Enregistrer',
    checkIn: 'Suivi',
    currentWeightLabel: 'Poids actuel',
    sinceStart: 'depuis le début',
    noCheckIns: 'Aucun suivi pour le moment. Ajoutez le premier pour commencer à suivre votre progression.',
    photosTapTwo: 'Touchez deux photos pour comparer',
    noPhoto: 'Aucune photo',
    compareSelected: 'Comparer la Sélection',
    compareTitle: 'Comparer la Progression',
    overSpan: 'changement sur cette période',
    avgIntakeTitle: 'Apport quotidien moyen (7 jours avant chaque photo)',
    avgIntakeNote: 'Les moyennes n\'incluent que les jours avec des repas enregistrés.',
    tipsTitle: 'Comment prendre des photos de progression',
    tipsIntro: 'Quelques conseils pour garder vos photos cohérentes afin de vraiment voir votre progression au fil du temps.',
    tip_sameTime_title: 'Même heure de la journée',
    tip_sameTime_desc: 'Prenez votre photo tôt le matin, avant de manger ou de boire, pour la comparaison la plus cohérente.',
    tip_sameSpot_title: 'Même endroit et éclairage',
    tip_sameSpot_desc: 'Utilisez le même endroit et le même éclairage à chaque fois pour que les ombres et la luminosité ne faussent pas la comparaison.',
    tip_clothing_title: 'Vêtements similaires',
    tip_clothing_desc: 'Portez des vêtements ajustés ou la même tenue à chaque fois pour que les changements de votre corps soient faciles à voir.',
    tip_angles_title: 'Angle cohérent',
    tip_angles_desc: 'Alignez-vous avec le contour à l\'écran et utilisez le même angle (face, profil ou dos) à chaque fois.',
    tipsGotIt: 'Compris',
  },
  ...
  home: {
    ...
    markFrequent: 'Marquer comme Fréquent',
    removeFrequent: 'Retirer des Fréquents',
    frequentMealCapTitle: 'Vous avez atteint votre limite gratuite',
    frequentMealCapBody: 'Les comptes gratuits peuvent enregistrer jusqu\'à {{limit}} repas fréquents. Passez à Premium pour un nombre illimité.',
    findNutritionInfo: 'Trouver les Infos Nutritionnelles',
    loading: 'Chargement...',
    ...
    delete: 'Supprimer',
    share: 'Partager',
    shareMeal: 'Partager le Repas',
    shareFailed: 'Impossible de partager ce repas. Veuillez réessayer.',
    selectMealsToDelete: 'Sélectionnez les repas à supprimer',
    mealsSelected: 'sélectionnés',
    compare: 'Comparer',
    deleteSelected: 'Supprimer la sélection',
    deleteMealsConfirm: 'Êtes-vous sûr de vouloir supprimer ces repas?',
    mealsDeleted: 'repas supprimés',
  ...
  submitProduct: {
    ...
    cropUsePhoto: 'Utiliser la photo',
    cropping: 'Recadrage...',
  },
  ...
  results: {
    ...
    allergenWarning: {
      ...
      reasons: {
        markedAsAllergen: 'Marqué comme allergène',
        notVegan: 'Non vegan',
        notVegetarian: 'Non végétarien',
        notPescatarian: 'Non pescétarien',
        containsGluten: 'Contient du gluten',
        containsLactose: 'Contient du lactose',
        highSodium: 'Riche en sodium',
        containsSugar: 'Contient du sucre',
        dietPrefix: 'Votre régime :',
        preferencePrefix: 'Préférence :',
      },
    },
  },
  ...
  displaySettings: {
    ...
    barsDescription: 'Barres horizontales avec progression linéaire',
  ...
  guest: {
    ...
    progress: 'Vos pesées et photos de progression apparaîtront ici une fois votre compte créé.',
  ...
  rateGate: {
    ...
    feedbackCancel: 'Passer',
    feedbackThankYou: 'Merci pour vos commentaires ! Nous lisons chaque message.',
  },
}
